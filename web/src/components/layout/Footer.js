        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Conecta con eventos increíbles, únete a tribus y descubre personas que comparten tus intereses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tribes" className="text-gray-300 hover:text-white transition-colors">
                  Tribus
                </Link>
              </li>
              <li>
