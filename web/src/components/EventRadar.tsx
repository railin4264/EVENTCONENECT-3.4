    ...
    <div className="relative">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-xl font-semibold text-foreground">Radar de Eventos</h3>
          ...
          */}
          ...
          {radarActive && (
            <div className="absolute inset-0 pointer-events-none">
              ...
              <div className="absolute inset-0 bg-gradient-conic from-primary/5 via-transparent to-primary/5 animate-spin" style={{ animationDuration: '10s' }} />
            </div>
          )}
        </Map>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-2">
                  {getMarkerIcon('type' in selectedItem ? 'event' : 'tribe')({ className: 'w-5 h-5 text-primary' })}
      ...
      <div className="mt-4 text-center">
        <div className="inline-flex items-center space-x-2 bg-muted/50 rounded-full px-4 py-2">
          <div className={`w-2 h-2 rounded-full ${radarActive ? 'bg-green-500' : 'bg-red-500'}`} />
          <span className="text-sm text-muted-foreground">
