        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="p-3 bg-white/5 rounded-lg">
              <div className="text-sm text-gray-400 mb-1">Mensaje de Bienvenida</div>
              <div className="text-white">{getLocalizedText('message.welcome')}</div>
            </div>
...
const CulturalAdaptation: React.FC<{
  ...
  const getGreeting = () => {
    ...
    const greetings = {
      ...
      'it': hour < 12 ? 'Buongiorno!' : hour < 18 ? 'Buon pomeriggio!' : 'Buonasera!',
      ...
      'ko': hour < 12 ? '좋은 아침입니다!' : hour < 18 ? '안녕하세요!' : '좋은 저녁입니다!'
    };
    ...
    <Card variant="glass" className={cn('w-full', className)}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-3 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-lg border border-cyan-400/20">
          <div className="text-cyan-400 text-sm font-medium mb-1">Saludo Personalizado</div>
          <div className="text-white text-lg">{getGreeting()}</div>
        </div>

        {/* Cultural Settings */}
        <div className="space-y-3">
          <h5 className="text-white font-medium">Configuraciones Culturales:</h5>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="p-3 bg-white/5 rounded-lg">
              <div className="text-sm text-gray-400 mb-1">Dirección del Texto</div>
              <div className="text-white">{language.direction.toUpperCase()}</div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-2">
            <label className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => setAdaptations({ ...adaptations, animations: e.target.checked })}
                className="rounded border-white/20 bg-white/10 text-cyan-400 focus:ring-cyan-400"
              />
              <span className="text-white text-sm">Animaciones adaptadas culturalmente</span>
            </label>
            ...
            <label className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => setAdaptations({ ...adaptations, greeting: e.target.checked })}
                className="rounded border-white/20 bg-white/10 text-cyan-400 focus:ring-cyan-400"
              />
              <span className="text-white text-sm">Saludos personalizados por hora</span>
            </label>
          </div>
        </div>
      </CardContent>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-white/5 rounded-lg">
                    ...
                    <div className="text-sm text-gray-300">Idiomas Soportados</div>
                  </div>
                  <div className="text-center p-3 bg-white/5 rounded-lg">
            ...
            <Card variant="glass" className="w-full">
              ...
              <CardContent className="space-y-4">
                {['es', 'en', 'fr', 'de'].map((langCode) => {
                  ...
                  const progress = langCode === 'es' ? 100 : langCode === 'en' ? 95 : langCode === 'fr' ? 85 : 75;
            ...
            <Card variant="glass" className="w-full">
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-white font-medium">{selectedLang?.nativeName}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-300">Dirección:</span>
                  <span className="text-white font-medium">{selectedLang?.direction.toUpperCase()}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-300">Formato de Fecha:</span>
                  <span className="text-white font-medium">{selectedLang?.dateFormat}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-300">Formato de Hora:</span>
                  <span className="text-white font-medium">{selectedLang?.timeFormat}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-300">Moneda:</span>
                  <span className="text-white font-medium">{selectedLang?.currency}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-300">Locale:</span>
                  <span className="text-white font-medium">{selectedLang?.locale}</span>
                </div>
              </CardContent>
            </Card>
          </div>
