...
import { Bell, X, Check, AlertTriangle, Info, Star, Zap, Heart, MessageCircle } from 'lucide-react';
...
export const useNotifications = (): NotificationContextType => {
  ...
  if (context === undefined) {
    throw new Error('useNotifications must be used within a ImmersiveNotificationSystem');
  }
  return context;
};