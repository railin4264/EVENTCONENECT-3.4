    ...
    <div className='space-y-6'>
      ...
      <div className='text-center'>
        ...
        <p className='text-gray-600 mt-2'>
          Instala la app, gestiona notificaciones y optimiza la experiencia
          offline
        </p>
      </div>
      ...
      <AnimatePresence>
        {showInstallPrompt && (
          ...
          >
            <Card
              variant='glass'
              className='p-4 shadow-2xl border-2 border-purple-500'
            >
      ...
      <AnimatePresence>
        {showUpdatePrompt && (
          ...
          >
            <Card
              variant='glass'
              className='p-4 shadow-2xl border-2 border-blue-500'
            >
              <div className='flex items-center space-x-3 mb-3'>
            ...
            <div className='flex items-start space-x-2'>
              ...
              <div className='text-sm text-blue-700'>
                ...
                <ul className='mt-1 space-y-1'>
                  <li>
                    • En Chrome: Busca el botón "Instalar" en la barra de
                    direcciones
                  </li>
                  <li>
                    • En Safari: Toca "Compartir" → "Añadir a pantalla de
                    inicio"
                  </li>
            ...
            <div className='bg-green-50 border border-green-200 rounded-lg p-3'>
              <div className='flex items-start space-x-2'>
                ...
                <div className='text-sm text-green-700'>
                  ...
                  <p>
                    Recibirás alertas sobre eventos, mensajes y actualizaciones
                    importantes
                  </p>
                </div>
              </div>
            ...
            <div className='bg-red-50 border border-red-200 rounded-lg p-3'>
              <div className='flex items-start space-x-2'>
                ...
                <div className='text-sm text-red-700'>
                  ...
                  <p>
                    Para recibir notificaciones, habilita los permisos en la
