...
const LazyParticleSystem = lazy(() => 
  import('@/components/advanced-systems/ParticleSystem').then(module => ({
    default: module.ParticleSystem
  }))
);
const LazyDynamicIllustration = lazy(() => 
  import('@/components/advanced-systems/DynamicIllustrations').then(module => ({
    default: module.DynamicIllustration
  }))
);
const LazyMorphingCard = lazy(() => 
  import('@/components/advanced-systems/FluidTransitions').then(module => ({
    default: module.MorphingCard
  }))
);
...
const ParticleField: React.FC = () => {
  ...
  // Delay particle system loading to improve LCP
  useEffect(() => {
  ...
  return (
    <Suspense fallback={null}>
      <LazyParticleSystem
        count={currentTheme?.particles?.count || 50}
        theme={currentTheme?.particles?.theme || 'default'}
        intensity={currentTheme?.particles?.intensity || 'medium'}
  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
        ...
        >
          <Suspense fallback={<div className="w-full h-48 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-xl animate-pulse" />}>
            <LazyDynamicIllustration
              type='person'
              context={
