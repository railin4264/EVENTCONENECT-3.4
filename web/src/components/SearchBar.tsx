...
export function SearchBar({
  ...
  const suggestions = [
    ...
    {
      type: 'tribe',
      text: 'Amantes del café',
      icon: Users,
      category: 'Social',
    },
    {
      type: 'event',
      text: 'Exposición de arte',
      icon: Calendar,
      category: 'Arte',
    },
    {
      type: 'tribe',
      text: 'Desarrolladores web',
      icon: Users,
      category: 'Tecnología',
    },
    {
                    ...
                    <div
                      className={cn(
                        ...
                        suggestion.type === 'event' &&
                          'bg-event-100 text-event-600',
                        suggestion.type === 'tribe' &&
                          'bg-tribe-100 text-tribe-600',
            ...
            <div className='grid grid-cols-2 gap-2'>
              {[
                ...
                return (
                  ...
                  >
                    <Icon
                      className={cn('w-4 h-4', `text-${category.color}-500`)}
                    />
