...
import { z } from 'zod';
import { Calendar, MapPin, Clock, Users, Image as ImageIcon, X, Upload } from 'lucide-react';
...
export default function EventCreateForm({ onSuccess, onCancel }: EventCreateFormProps) {
  ...
  const createEventMutation = useMutation({
    mutationFn: (data: EventFormData) => api.events.createEvent(data),
    onSuccess: (data) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Crear Nuevo Evento</h2>
