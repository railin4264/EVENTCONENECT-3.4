    ...
    return (
      <div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='text-gray-600 mb-4'>Redirigiendo a EventConnect...</p>
        ...
        <div className='bg-blue-50 border border-blue-200 rounded-lg p-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-blue-800'>
            <div className='flex items-start'>
              ...
              <p className='text-sm'>
                Los eventos y tribus que has visitado recientemente están
                disponibles offline
              </p>
            </div>
            <div className='flex items-start'>
      ...
      <div className='bg-white border-t mt-12'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
          <div className='text-center text-sm text-gray-500'>
            <p>EventConnect - Funcionando en modo offline</p>
            <p className='mt-1'>
              La aplicación se sincronizará automáticamente cuando se restaure
              la conexión
            </p>
          </div>
        </div>
