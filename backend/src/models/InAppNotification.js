...
// Métodos estáticos
inAppNotificationSchema.statics.findUnreadByUser = function (
  userId,
  limit = 50
) {
  return this.find({
...
inAppNotificationSchema.statics.findByUserAndType = function (
  userId,
  type,
  limit = 50
) {
...
inAppNotificationSchema.statics.findHighPriorityByUser = function (
  userId,
  limit = 20
) {
  return this.find({
...
inAppNotificationSchema.statics.cleanupOldNotifications = function (
  userId,
  daysOld = 30
) {
...
inAppNotificationSchema.statics.getNotificationStats = function (
  userId,
  timeRange = '7d'
) {
