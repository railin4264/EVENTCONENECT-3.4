...
const mockEvents = [
  {
    ...
    description:
      'El evento tecnológico más importante de Barcelona. Charlas sobre IA, blockchain y desarrollo web.',
    category: 'tecnología',
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          'Excelente evento, muy bien organizado y contenido de calidad.',
  ...
  },
  {
    ...
    description:
      'Aprende técnicas avanzadas de React: hooks personalizados, context API, y optimización de performance.',
    category: 'tecnología',
  ...
  },
  {
    ...
    description:
      'Descubre las últimas tendencias en diseño de experiencia de usuario e interfaces.',
    category: 'diseño',
    tags: ['UX', 'UI', 'Design'],
    host: {
      id: '2',
...
const mockTribes = [
  {
    ...
    description:
      'Comunidad de entusiastas de la tecnología en Barcelona. Compartimos conocimiento, organizamos eventos y construimos el futuro.',
    category: 'tecnología',
    privacy: 'public',
    creator: {
      id: '2',
  ...
  },
  {
    ...
    description:
      'Comunidad para amantes de la música y el arte en Madrid. Organizamos conciertos, exposiciones y talleres.',
    category: 'arte',
    privacy: 'public',
    creator: {
      id: '1',
  ...
  },
  {
    ...
    description:
      'Comunidad de desarrolladores en Valencia. Compartimos conocimiento, organizamos hackathons y construimos proyectos juntos.',
    category: 'tecnología',
    privacy: 'public',
    creator: {
      id: '3',
...
const mockPosts = [
  {
    id: '1',
    content:
      '¡Acabamos de confirmar el próximo Tech Meetup Barcelona! Será el 15 de diciembre con charlas increíbles sobre IA y blockchain. ¿Quién se apunta? 🚀',
    type: 'event',
    author: {
      id: '2',
      username: 'maria_garcia',
  ...
  },
  {
    id: '2',
    content:
      'Excelente workshop de React ayer en Valencia. Aprendí mucho sobre hooks personalizados y optimización. ¡Gracias a todos los asistentes! 💻',
    type: 'event',
    author: {
      id: '3',
      username: 'carlos_lopez',
  ...
  },
  {
    id: '3',
    content:
      'La conferencia de UX/UI en Madrid fue un éxito total. Más de 400 asistentes y charlas de nivel internacional. ¡El diseño está vivo! 🎨',
    type: 'event',
    author: {
      id: '2',
      username: 'maria_garcia',
