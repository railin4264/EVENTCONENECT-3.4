...
const userSchema = new mongoose.Schema({
  ...
  preferences: {
    ...
    privacy: {
      ...
      activityVisibility: { type: String, enum: ['public', 'friends', 'private'], default: 'public' }
    },
...
userSchema.methods.generateRefreshToken = function(device = 'unknown', ip = 'unknown') {
...
userSchema.methods.addBadge = function(badgeType, badgeName, badgeDescription, badgeIcon) {
