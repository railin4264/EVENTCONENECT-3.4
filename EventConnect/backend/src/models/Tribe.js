    ...
    rules: [
      {
        title: {
          ...
          maxlength: [
            100,
            'El título de la regla no puede exceder 100 caracteres',
          ],
        },
        description: {
          type: String,
          ...
          maxlength: [
            500,
            'La descripción de la regla no puede exceder 500 caracteres',
          ],
        },
        isActive: {
          type: Boolean,
    ...
    resources: [
      {
        title: {
          ...
          maxlength: [
            200,
            'El título del recurso no puede exceder 200 caracteres',
          ],
        },
        description: String,
        type: {
    ...
    discussions: [
      {
        title: {
          ...
          maxlength: [
            200,
            'El título de la discusión no puede exceder 200 caracteres',
          ],
        },
        content: {
          type: String,
...
// Static methods
tribeSchema.statics.findNearby = function (
  coordinates,
  maxDistance = 10000,
  limit = 20
) {
