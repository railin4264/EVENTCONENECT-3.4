...
const validateEventCreation = [
  ...
  body('description')
    ...
    .withMessage('La descripción del evento debe tener entre 10 y 2000 caracteres'),
  ...
  body('location.coordinates')
    .optional()
    .isArray({ min: 2, max: 2 })
    .withMessage('Las coordenadas deben ser un array de 2 elementos [longitud, latitud]'),
...
const validateTribeCreation = [
  ...
  body('description')
    .trim()
    .isLength({ min: 10, max: 2000 })
    .withMessage('La descripción de la tribu debe tener entre 10 y 2000 caracteres'),
...
const validatePostCreation = [
  ...
  body('poll.options.*.text')
    ...
    .trim()
    .isLength({ min: 1, max: 100 })
    .withMessage('Cada opción de la encuesta debe tener entre 1 y 100 caracteres'),
...
const validateSearch = [
  ...
  query('location')
    .optional()
    .isArray({ min: 2, max: 2 })
    .withMessage('Las coordenadas de ubicación deben ser un array de 2 elementos'),
...
const validatePagination = [
  ...
  query('sort')
    .optional()
    .isIn(['createdAt', 'updatedAt', 'name', 'title', 'date', 'popularity', 'rating'])
