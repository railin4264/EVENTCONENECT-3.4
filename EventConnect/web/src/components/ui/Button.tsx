...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    // ===== ICON WRAPPER =====
    const IconWrapper = ({ children, position }: { children: React.ReactNode; position: 'left' | 'right' }) => (
      <span className={cn(
...
export const ButtonGroup: React.FC<ButtonGroupProps> = ({ 
  ...
  return (
    <div className={cn(
      ...
      orientation === 'horizontal' ? 'divide-x divide-white/20' : 'divide-y divide-white/20',
      ...
      {React.Children.map(children, (child, index) => (
        <div className={cn(
          ...
          orientation === 'horizontal' && 'first:rounded-l-lg last:rounded-r-lg',
