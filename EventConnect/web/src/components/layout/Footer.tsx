...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Instagram', href: 'https://instagram.com/eventconnect', icon: '📷' },
    { name: 'LinkedIn', href: 'https://linkedin.com/company/eventconnect', icon: '💼' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md">
              Conecta con eventos increíbles, únete a tribus apasionadas y descubre experiencias únicas cerca de ti. 
              La plataforma social para amantes de los eventos.
            </p>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-8 mb-8">
          <div className="max-w-md">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm">
              Recibe las últimas noticias sobre eventos, nuevas funcionalidades y actualizaciones de la plataforma.
            </p>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              <span>© {currentYear} EventConnect. Todos los derechos reservados.</span>
              <span>•</span>
              <span>Hecho con</span>
